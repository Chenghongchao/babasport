			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="radio" name="isDisplay" <c:if test="${brand.isDisplay}">checked="true"</c:if> value="1"/>可用
						<input type="radio" name="isDisplay" <c:if test="${!brand.isDisplay}">checked="true"</c:if> value="0"/>不可用
					</td>
				</tr>
			</tbody>
			<tbody>
