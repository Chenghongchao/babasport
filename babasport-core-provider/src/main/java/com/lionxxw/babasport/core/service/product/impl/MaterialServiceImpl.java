...
import com.lionxxw.babasport.core.dao.product.MaterialDao;
...
public class MaterialServiceImpl implements MaterialService {
    ...
    public MaterialDto save(MaterialDto obj) throws Exception {
        ...
        Material material = BeanUtils.createBeanByTarget(obj, Material.class);
    ...
    public boolean delById(Integer id) throws Exception {
        ExceptionUtils.checkIdIsNull(id, Material.class, "delById");
    ...
    public void update(MaterialDto obj) throws Exception {
        ExceptionUtils.checkObjIsNull(obj);
        ExceptionUtils.checkIdIsNull(obj.getId(), Material.class, "update");
        Material material = BeanUtils.createBeanByTarget(obj, Material.class);
        materialDao.updateByPrimaryKeySelective(material);
    }

    public MaterialDto getById(Integer id) throws Exception {
        ExceptionUtils.checkIdIsNull(id, Material.class, "getById");
        Material material = materialDao.selectByPrimaryKey(id);
        MaterialDto dto = BeanUtils.createBeanByTarget(material, MaterialDto.class);
        return dto;
    }
    ...
    public List<MaterialDto> queryByParam(MaterialDto obj) throws Exception {
        ...
        if (null != materials && materials.size() > 0){
            List<MaterialDto> list = BeanUtils.createBeanListByTarget(materials, MaterialDto.class);
            return list;
        }
        return null;
    }
